    ...
    <div class="container">
        ...
        <div class=" eventform-con clearfix">
            <form action="{{url('/get-eventos')}}" method="get" autocomplete="off">
                ...
                <div class="form-input">
                    <input type="text" placeholder="Entre a data ?" class="date_timepicker_start" name="data1" autocomplete="false">
                    <button type="button"  value="open" class="open icon fa fa-calendar"></button>
                </div>


                <div class="form-input">
                    <input type="text" placeholder="ate a data ? " class="date_timepicker_end" name="data2" autocomplete="false">
                ...
                <div class="form-input ">
                    <button class="btn btn-disabled ">Procurar</button>
                </div>
